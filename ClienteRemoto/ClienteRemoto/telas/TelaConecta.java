    ...
    public synchronized void enviaPosMouse( String codigo) {
        try {
            ...
            try {
                conecta.envia.writeUTF(codigo);
                conecta.envia.flush();
                conecta.envia.writeInt(posX1Mouse);
                conecta.envia.flush();
                conecta.envia.writeInt(posY1Mouse);
                conecta.envia.flush();
                //2222
                conecta.envia.writeInt(posX2Mouse);
                conecta.envia.flush();
                conecta.envia.writeInt(posY2Mouse);
                conecta.envia.flush();
...
//                exibeimagem.setBounds(d);
    ...
    private void initComponents() {
        ...
        ButtonMarcaDouble1 = new javax.swing.JButton();
        ButtonMarcaDouble2 = new javax.swing.JButton();
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(ip, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        ButtonMarcaDouble1.setText("MARCADOUBLE1");
        ButtonMarcaDouble1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ButtonMarcaDouble1ActionPerformed(evt);
            }
        });

        ButtonMarcaDouble2.setText("ButtonMarcaDouble2");
        ButtonMarcaDouble2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ButtonMarcaDouble2ActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(exibeimagem, javax.swing.GroupLayout.DEFAULT_SIZE, 882, Short.MAX_VALUE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(btnMarca, javax.swing.GroupLayout.PREFERRED_SIZE, 221, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(ButtonMarcaDouble1, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(ButtonMarcaDouble2, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(ButtonMarcaDouble1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(ButtonMarcaDouble2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private int posX1Mouse = 0;
    private int posY1Mouse = 0;
    private int posX2Mouse = 0;
    private int posY2Mouse = 0;
    ...
    private void exibeimagemMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_exibeimagemMousePressed
        ...
        } else if(marcadoraButton1){
            marcadoraButton1 = false;
            posX1Mouse = evt.getXOnScreen();
            posY1Mouse = evt.getYOnScreen();
            if(posX2Mouse != 0 && posY2Mouse != 0){
                //existe
                enviaPosMouse("111");
            }
        }else if(marcadoraButton2){
            marcadoraButton2 = false;
            posX2Mouse = evt.getXOnScreen();
            posY2Mouse = evt.getYOnScreen();
            if(posX1Mouse != 0 && posY1Mouse != 0){
                //existe
                enviaPosMouse("111");
            }
        }else{
    ...
    private static boolean marcadoraButton1 = false;
    private static boolean marcadoraButton2 = false;
    
    private void ButtonMarcaDouble1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonMarcaDouble1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ButtonMarcaDouble1ActionPerformed

    private void ButtonMarcaDouble2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonMarcaDouble2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ButtonMarcaDouble2ActionPerformed
    ...
    private javax.swing.JButton ButtonMarcaDouble1;
    private javax.swing.JButton ButtonMarcaDouble2;
